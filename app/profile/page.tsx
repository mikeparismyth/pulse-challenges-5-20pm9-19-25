      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mobile-bottom-spacing">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="backdrop-blur-sm bg-white/10 rounded-lg border border-gray-700 p-6 text-center">
            ...
            <div className="text-gray-300 text-sm">Challenges Won</div>
          </div>
          ...
          <div className="backdrop-blur-sm bg-white/10 rounded-lg border border-gray-700 p-6 text-center">
            ...
            <div className="text-gray-300 text-sm">Total Challenges</div>
          </div>
          ...
          <div className="backdrop-blur-sm bg-white/10 rounded-lg border border-gray-700 p-6 text-center">
            <div className="text-2xl font-bold text-white mb-1">
              {Math.round((userStats.challengesWon / userStats.totalChallenges) * 100)}%
            </div>
            ...
            {recentChallenges.map((challenge, index) => (
              ...
              >
                <div className="mb-2 sm:mb-0">
                  ...
                  <p className="text-gray-300 text-sm">{challenge.date}</p>
                </div>
                
                <div className="flex items-center gap-4">
                  <span
                    className={`px-3 py-1 rounded-full text-sm font-medium ${
                      challenge.placement === '1st'
                        ? 'bg-yellow-500/20 text-yellow-400'
                        : challenge.placement === '2nd'
                        ? 'bg-gray-400/20 text-gray-300'
                        : challenge.placement === '3rd'
                        ? 'bg-orange-500/20 text-orange-400'
                        : 'bg-gray-500/20 text-gray-400'
                    }`}
                  >
                    {challenge.placement} Place
                  </span>
